...
//    private final ModeParameters parameters;
    ...
    public List<? extends PlanElement> calcRoute(RoutingRequest routingRequest) {
        ...
        List<? extends PlanElement> carElements = carRoutingModule.calcRoute(toPRRoutingrequest); // Biao: why is this null in default setting?
...
/*        Leg leg = (Leg) carElements.get(0);
        ...
        List<? extends PlanElement> ptElements = ptRoutingModule.calcRoute(toDestRoutingrequest);
