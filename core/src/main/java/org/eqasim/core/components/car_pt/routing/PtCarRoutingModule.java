...
public class PtCarRoutingModule implements RoutingModule{
    ...
    public List<? extends PlanElement> calcRoute(RoutingRequest routingRequest) {
        ...
        RoutingRequest toPRRoutingrequest = DefaultRoutingRequest.of(fromFacility, prkFacility, departureTime,person,attributes);
        List<? extends PlanElement> ptElements = ptRoutingModule.calcRoute(toPRRoutingrequest);
...
*/
        ...
        RoutingRequest toDestRoutingrequest = DefaultRoutingRequest.of(prkFacility, toFacility, carDepartureTime,person, attributes);
        List<? extends PlanElement> carElements = carRoutingModule.calcRoute(toDestRoutingrequest); // Biao: why is this null in default setting?
